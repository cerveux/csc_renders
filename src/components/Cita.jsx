...
function Cita() {
    return (
        <div className="cita-container" style={{width:"80%"}}>
            <svg  className="comillas" preserveAspectRatio="xMidYMid meet" data-bbox="48.8 51 102.4 98.1" xmlns="http://www.w3.org/2000/svg" viewBox="48.8 51 102.4 98.1" role="presentation" aria-hidden="true">
                <g>
